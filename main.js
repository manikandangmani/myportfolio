    ...
    document.querySelectorAll('a').forEach(link => {
      ...
      if (href && href.endsWith('.html') && !href.startsWith('#')) {
        link.addEventListener('click', e => {
          ...
          if (direction === 'next') {
            transitionOverlay.classList.add('slide-left');
            transitionOverlay.classList.remove('slide-right');
          } else if (direction === 'back' || direction === 'prev') {
            transitionOverlay.classList.add('slide-right');
            transitionOverlay.classList.remove('slide-left');
          } else {
            transitionOverlay.classList.remove('slide-left');
            transitionOverlay.classList.remove('slide-right');
          }
          ...
          transitionOverlay.classList.add('animate-out');
